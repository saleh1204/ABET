...
$(document).ready(function () {
    ...
    $("#demo-form2").on('click', '#save', function () {
        ...
        {
            //alert('2 ' + $col1 + $col2);
            // $request->get('newWeightName'), $request->get('newWeightValue'), $request->get('dateActivated'), $request->get('dateDeactivated'), $request->get('statusName'), $request->get('weightName'), $request->get('weightValue'), 'Employer-Based', $request->get('pname'));
            var parameters = {
                grp: "Coordinator",
                cmd: "updateEmpAnswer",
                statusName: newC5,
